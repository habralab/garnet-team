...
export const FormUser: FC<FormUserProps> = ({ formValues, handleChange, handleDisabled }) => {
  ...
  const handleChangeErrors = (field: keyof FormUserValues, value?: string | string[]) =>
  ...
  const updateErrorsText = (field: keyof FormUserValues) => () => {
    validateValue(formUserErrors, field, formValues[field], handleChangeErrors(field))
  }

  const handleChangeTags = (tags: string[] | string) => {
    validateValue(formUserErrors, 'tags', tags, handleChangeErrors('tags', tags))
