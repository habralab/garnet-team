...
namespace Garnet.Projects.Infrastructure.MongoDb.ProjectTeam
{
    public record ProjectTeamDocument
    {
        ...
        public string TeamDescription { get; init; } = null!;
        ...
        {
            return new ProjectTeamEntity(doc.Id, doc.TeamName, doc.OwnerUserId, doc.TeamAvatarUrl, doc.TeamDescription,
                doc.UserParticipantIds);
        }
    }
}