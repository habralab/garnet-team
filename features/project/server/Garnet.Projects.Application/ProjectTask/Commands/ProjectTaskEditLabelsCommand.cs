...
public class ProjectTaskEditLabelsCommand
{
    ...
    public ProjectTaskEditLabelsCommand(
    ...
    public async Task<Result<ProjectTaskEntity>> Execute(CancellationToken ct, string taskId, string[] labels)
    {
        ...
        task = await _projectTaskRepository.EditProjectTaskLabels(ct, taskId, labels);
