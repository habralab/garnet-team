...
public class ProjectTaskEditTagsCommand
{
    ...
    public ProjectTaskEditTagsCommand(
    ...
    public async Task<Result<ProjectTaskEntity>> Execute(CancellationToken ct, string taskId, string[] tags)
    {
        ...
        task = await _projectTaskRepository.EditProjectTaskTags(ct, taskId, tags);
