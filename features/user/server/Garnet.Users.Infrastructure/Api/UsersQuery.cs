...
public class UsersQuery
{
    ...
    public async Task<UserPayload> GetUser(CancellationToken ct, string id)
    {
        ...
        return new UserPayload(user.Id, user.UserName, user.Description, user.Tags);
    }
    ...
    public async Task<UsersFilterPayload> FilterUsers(CancellationToken ct, UsersFilterInput input)
    {
        ...
        return new UsersFilterPayload(users.Select(o => new UserPayload(o.Id, o.UserName, o.Description, o.Tags)).ToArray());
    }
}